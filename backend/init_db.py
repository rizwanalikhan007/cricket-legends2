...
def init_db():
    ...
    cricketers = [
        ...
        ('Rohit Sharma', 'India', 'Batsman',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/1/1e/Prime_Minister_Of_Bharat_Shri_Narendra_Damodardas_Modi_with_Shri_Rohit_Gurunath_Sharma%28Cropped%29.jpg'),
        ...
        ('Ravichandran Ashwin', 'India', 'All-rounder',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/d/da/The_Minister_of_State_for_Youth_Affairs_and_Sports_conffering_the_Arjuna_Award_on_cricketer_Ravichandran_Ashwin.jpg'),
        ...
        ('Kapil Dev', 'India', 'All-rounder',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/8/88/Kapil_Dev_at_Equation_sports_auction_%283x4_cropped%29.jpg'),
        ...
        ('Rahul Dravid', 'India', 'Batsman',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/1/17/Rahul_Dravid_in_2024.jpg'),
        ...
        ('Sourav Ganguly', 'India', 'Batsman',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/e/e8/Sourav_Ganguly_closeup.jpg'),
        ...
        ('Sunil Gavaskar', 'India', 'Batsman',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/e/ed/Sunny_Gavaskar_Sahara.jpg'),
        ...
        ('Don Bradman', 'Australia', 'Batsman',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/d/d8/Don_Bradman_1930.jpg'),
        ...
        ('Ricky Ponting', 'Australia', 'Batsman',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/4/49/Ricky_Ponting_2015.jpg'),
        ...
        ('Shane Warne', 'Australia', 'Bowler',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/f/ff/Shane_Warne_February_2015.jpg'),
        ...
        ('Adam Gilchrist', 'Australia', 'Wicketkeeper-Batsman',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/1/1f/Adam_Gilchrist_of_Australia_%28cropped%29.jpg'),
        ...
        ('Wasim Akram', 'Pakistan', 'Bowler',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/f/f4/Wasim-akram-gesf-2018-7878.jpg'),
        ...
        ('Babar Azam', 'Pakistan', 'Batsman',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/4/43/Babar_azam_2023.jpg'),
        ...
        ('Shaheen Afridi', 'Pakistan', 'Bowler',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Shaheen_Afridi.jpg/400px-Shaheen_Afridi.jpg'),
        ...
        ('James Anderson', 'England', 'Bowler',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/e/e5/JIMMY_ANDERSON.jpg'),
        ...
        ('Joe Root', 'England', 'Batsman',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/f/f7/Joe_Root_HIP1487_%28cropped%29.jpg'),
        ...
        ('Ben Stokes', 'England', 'All-rounder',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/3/3e/BEN_STOKES_%2811704787023%29_%28cropped%29.jpg'),
        ...
        ('AB de Villiers', 'South Africa', 'Batsman',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/e/e0/AB_de_villiers_%28cropped%29.jpg'),
        ...
        ('Dale Steyn', 'South Africa', 'Bowler',
         ...
         'https://media.crictracker.com/media/featureimage/2019/12/Dale-Steyn-picture.jpg'),
        ...
        ('Brian Lara', 'West Indies', 'Batsman',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/9/92/Brian_Lara_at_2012_Mumbai_Marathon_pre_bash.jpg'),
        ...
        ('Kumar Sangakkara', 'Sri Lanka', 'Wicketkeeper-Batsman',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/b/bd/Kumar_Sangakkara_bat_in_hand.JPG'),
        ...
        ('Shubman Gill', 'India', 'Batsman',
         ...
         'Minimal controversies.',
         'https://goyahills.com/wp-content/uploads/2025/03/Shubman-Gill.jpg'),
        ...
        ('Mohammad Rizwan', 'Pakistan', 'Wicketkeeper-Batsman',
         ...
         'Minimal controversies.',
         'https://upload.wikimedia.org/wikipedia/commons/a/af/M_Rizwan.jpg'),
        ...
        ('Kagiso Rabada', 'South Africa', 'Bowler',
         ...
         'https://www.astrosage.com/celebrity-horoscope/img/Kagiso-Rabada-horoscope.jpg'),
        ...
        ('Glenn Maxwell', 'Australia', 'All-rounder',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/4/43/Glenn_Maxwell_3.jpg'),
        ...
        ('Tim Southee', 'New Zealand', 'Bowler',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/a/a5/Tim_Southee_ONZM_%28cropped%29.jpg'),
        ...
        ('Lasith Malinga', 'Sri Lanka', 'Bowler',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/2/26/Lasith_Malinga_tossing_a_cricket_ball_at_practice.jpg'),
        ...
        ('Shahid Afridi', 'Pakistan', 'All-rounder',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/1/13/Shahid_Afridi_in_2017_%283x4_cropped%29.jpg'),
        ...
        ('Alastair Cook', 'England', 'Batsman',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/c/c7/Alastair_Cook_vs_Upminster_CC.jpg'),
        ...
        ('Stuart Broad', 'England', 'Bowler',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/4/45/Stuart_broad.jpg'),
        ...
        ('Mahela Jayawardene', 'Sri Lanka', 'Batsman',
         ...
         'Minimal controversies.',
         'https://upload.wikimedia.org/wikipedia/commons/f/f7/Mahela_Jayawardene_3.JPG'),
        ...
        ('Curtly Ambrose', 'West Indies', 'Bowler',
         ...
         'Minimal controversies.',
         'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/Curtly_Ambrose.jpg/400px-Curtly_Ambrose.jpg'),
        ...
        ('Chris Gayle', 'West Indies', 'Batsman',
         ...
         'https://upload.wikimedia.org/wikipedia/commons/f/f8/Two_views_of_Chris_Gayle_%2848020785077%29.jpg'),
        ...
        # Additional Cricketers
        ('Steve Waugh', 'Australia', 'Batsman',
         'Australian captain 1999-2004. Tough competitor. 168 Tests.',
         '41 Test wins as captain. ICC Hall of Fame. Twin of Mark Waugh.',
         '10,927 Test runs. 32 Test centuries. 200 highest score.',
         'Minimal controversies.',
         'https://upload.wikimedia.org/wikipedia/commons/8/82/SRWaugh.png'),

        ('Cameron Green', 'Australia', 'All-rounder',
         'Tall all-rounder. Future star. Debuted 2020.',
         'Test all-rounder. 2023 WTC winner. IPL star.',
         '2,000+ international runs. 50+ wickets. 174* highest Test score.',
         'Minimal controversies.',
         'https://upload.wikimedia.org/wikipedia/commons/b/b4/Cameron_Green_fielding_Boxing_Day_2022_%28cropped%29.jpg'),

        ('Abhishek Sharma', 'India', 'All-rounder',
         'Young left-handed all-rounder. IPL sensation.',
         'IPL century. T20I debut 2024. Explosive batsman.',
         '100+ T20 sixes. Left-arm spinner.',
         'Minimal controversies.',
         'https://goyahills.com/wp-content/uploads/2025/03/Abhishek-Sharma.png'),

        ('Andrew Strauss', 'England', 'Batsman',
         'England captain 2009-2012. Led to No.1 Test ranking.',
         '2009, 2011 Ashes winner. 100 Tests. England director.',
         '7,037 Test runs. 21 Test centuries. 177 highest score.',
         'Minimal controversies.',
         'https://upload.wikimedia.org/wikipedia/commons/6/62/Andrew_Strauss.JPG'),

        ('Jason Roy', 'England', 'Batsman',
         'Explosive opener. 2019 World Cup winner.',
         '2019 WC winner. 180 strike rate in T20Is.',
         '4,000+ ODI runs. 180 highest ODI score.',
         'Minimal controversies.',
         'https://upload.wikimedia.org/wikipedia/commons/e/ed/Jason_Roy_with_the_Sydney_Sixers.jpg'),

        ('Dewald Brevis', 'South Africa', 'Batsman',
         'Baby AB. Young sensation. U19 World Cup star 2022.',
         'U19 WC Player of Tournament 2022. IPL player.',
         '162 in U19 WC. T20 leagues star.',
         'Minimal controversies.',
         'https://www.svgrepo.com/show/410428/cricket-player.svg'),

        ('Jonty Rhodes', 'South Africa', 'Batsman',
         'Greatest fielder ever. Revolutionized fielding.',
         '1992, 1999 WC semi-finalist. Fielding coach.',
         '5,935 ODI runs. 245 catches. Run-out king.',
         'Minimal controversies.',
         'https://upload.wikimedia.org/wikipedia/commons/9/9b/JONTY_RHODES.jpg'),

        ('Ross Taylor', 'New Zealand', 'Batsman',
         'NZ\'s leading run-scorer. 450 internationals.',
         'Most runs for NZ. 2015, 2019 WC finalist.',
         '18,199 international runs. 40 centuries. 290 highest ODI.',
         'Racism allegations in autobiography.',
         'https://upload.wikimedia.org/wikipedia/commons/0/0e/Ross_Taylor_CNZM_%28cropped%29.jpg'),

        ('Rachin Ravindra', 'New Zealand', 'All-rounder',
         'Young left-handed all-rounder. 2023 WC star.',
         '3 centuries in 2023 WC. Test all-rounder.',
         '578 runs in 2023 WC. Left-arm spinner.',
         'Minimal controversies.',
         'https://akm-img-a-in.tosshub.com/indiatoday/images/story/202410/rachin-ravindra.jpg'),

        ('Carlos Brathwaite', 'West Indies', 'All-rounder',
         '2016 T20 WC final hero. 4 sixes in 4 balls.',
         '2016 T20 WC winner. Captain. Commentator.',
         '4 sixes in final over vs England. All-rounder.',
         'Minimal controversies.',
         'https://upload.wikimedia.org/wikipedia/commons/2/20/Carlos_Brathwaite.jpg'),

        ('Shoaib Akhtar', 'Pakistan', 'Bowler',
         'Rawalpindi Express. Fastest bowler ever (161.3 km/h).',
         'Fastest delivery 161.3 km/h. 178 Test wickets.',
         '444 international wickets. 6/11 best ODI.',
         'Drug ban. Ball-tampering. Controversies.',
         'https://upload.wikimedia.org/wikipedia/commons/0/02/Khizer_Ahmed_and_mentor_Shoaib_Akhtar_%28cropped%29.jpg'),
    ]
