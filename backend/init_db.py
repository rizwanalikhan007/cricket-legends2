...
def init_db():
    ...
    cricketers = [
        ...
        ('Sachin Tendulkar', 'India', 'Batsman', 
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Sachin'),
        ...
        ('Virat Kohli', 'India', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Kohli'),
        ...
        ('MS Dhoni', 'India', 'Wicketkeeper-Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Dhoni'),
        ...
        ('Rohit Sharma', 'India', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Rohit'),
        ...
        ('Jasprit Bumrah', 'India', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Bumrah'),
        ...
        ('Ravichandran Ashwin', 'India', 'All-rounder',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Ashwin'),
        ...
        ('Kapil Dev', 'India', 'All-rounder',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Kapil'),
        ...
        ('Rahul Dravid', 'India', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Dravid'),
        ...
        ('Sourav Ganguly', 'India', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Ganguly'),
        ...
        ('Sunil Gavaskar', 'India', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Gavaskar'),
        ...
        ('Don Bradman', 'Australia', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Bradman'),
        ...
        ('Ricky Ponting', 'Australia', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Ponting'),
        ...
        ('Shane Warne', 'Australia', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Warne'),
        ...
        ('Steve Smith', 'Australia', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Smith'),
        ...
        ('Glenn McGrath', 'Australia', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=McGrath'),
        ...
        ('Adam Gilchrist', 'Australia', 'Wicketkeeper-Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Gilchrist'),
        ...
        ('Pat Cummins', 'Australia', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Cummins'),
        ...
        ('David Warner', 'Australia', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Warner'),
        ...
        ('Mitchell Starc', 'Australia', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Starc'),
        ...
        ('Brett Lee', 'Australia', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Lee'),

        // Continue with more cricketers...
        // Pakistani Legends
        ('Wasim Akram', 'Pakistan', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Wasim'),
        ...
        ('Imran Khan', 'Pakistan', 'All-rounder',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Imran'),
        ...
        ('Babar Azam', 'Pakistan', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Babar'),
        ...
        ('Shaheen Afridi', 'Pakistan', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Shaheen'),
        ...
        ('Waqar Younis', 'Pakistan', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Waqar'),
        ...
        ('James Anderson', 'England', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Anderson'),
        ...
        ('Joe Root', 'England', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Root'),
        ...
        ('Ben Stokes', 'England', 'All-rounder',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Stokes'),
        ...
        ('Jacques Kallis', 'South Africa', 'All-rounder',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Kallis'),
        ...
        ('AB de Villiers', 'South Africa', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=ABD'),
        ...
        ('Dale Steyn', 'South Africa', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Steyn'),
        ...
        ('Brian Lara', 'West Indies', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Lara'),
        ...
        ('Viv Richards', 'West Indies', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Viv'),
        ...
        ('Kumar Sangakkara', 'Sri Lanka', 'Wicketkeeper-Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Sanga'),
        ...
        ('Muttiah Muralitharan', 'Sri Lanka', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Murali'),
        ...
        ('Kane Williamson', 'New Zealand', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Kane'),
        ...
        ('Richard Hadlee', 'New Zealand', 'All-rounder',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Hadlee'),
        ...
        ('Shakib Al Hasan', 'Bangladesh', 'All-rounder',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Shakib'),
        ...
        ('Rashid Khan', 'Afghanistan', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Rashid'),
        ...
        ('Travis Head', 'Australia', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Head'),
        ...
        ('Rishabh Pant', 'India', 'Wicketkeeper-Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Pant'),
        ...
        ('Shubman Gill', 'India', 'Batsman',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Gill'),
        ...
        ('Mohammad Rizwan', 'Pakistan', 'Wicketkeeper-Batsman',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Rizwan'),
        ...
        ('Harry Brook', 'England', 'Batsman',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Brook'),
        ...
        ('Kagiso Rabada', 'South Africa', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Rabada'),
        ...
        ('Trent Boult', 'New Zealand', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Boult'),
        ...
        ('Quinton de Kock', 'South Africa', 'Wicketkeeper-Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=DeKock'),
        ...
        ('Jos Buttler', 'England', 'Wicketkeeper-Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Buttler'),
        ...
        ('Marnus Labuschagne', 'Australia', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Marnus'),
        ...
        ('Glenn Maxwell', 'Australia', 'All-rounder',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Maxwell'),
        ...
        ('Suryakumar Yadav', 'India', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=SKY'),
        ...
        ('Mohammad Shami', 'India', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Shami'),
        ...
        ('Ravindra Jadeja', 'India', 'All-rounder',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Jadeja'),
        ...
        ('KL Rahul', 'India', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Rahul'),
        ...
        ('Hardik Pandya', 'India', 'All-rounder',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Hardik'),
        ...
        ('Axar Patel', 'India', 'All-rounder',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Axar'),
        ...
        ('Haris Rauf', 'Pakistan', 'Bowler',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Rauf'),
        ...
        ('Shadab Khan', 'Pakistan', 'All-rounder',
         ...
         'Fitness concerns.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Shadab'),
        ...
        ('Fakhar Zaman', 'Pakistan', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Fakhar'),
        ...
        ('Wanindu Hasaranga', 'Sri Lanka', 'All-rounder',
         ...
         'Central contract disputes.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Wanindu'),
        ...
        ('Pathum Nissanka', 'Sri Lanka', 'Batsman',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Pathum'),
        ...
        ('Tim Southee', 'New Zealand', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Southee'),
        ...
        ('Devon Conway', 'New Zealand', 'Batsman',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Conway'),
        ...
        ('Daryl Mitchell', 'New Zealand', 'All-rounder',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Mitchell'),
        ...
        ('Sam Curran', 'England', 'All-rounder',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Curran'),
        ...
        ('Moeen Ali', 'England', 'All-rounder',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Moeen'),
        ...
        ('Jofra Archer', 'England', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Archer'),
        ...
        ('Andre Russell', 'West Indies', 'All-rounder',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Russell'),
        ...
        ('Kieron Pollard', 'West Indies', 'All-rounder',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Pollard'),
        ...
        ('Mushfiqur Rahim', 'Bangladesh', 'Wicketkeeper-Batsman',
         ...
         'Umpire altercation.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Mushfiqur'),
        ...
        ('Tamim Iqbal', 'Bangladesh', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Tamim'),
        ...
        ('Mohammad Nabi', 'Afghanistan', 'All-rounder',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Nabi'),
        ...
        ('Jonny Bairstow', 'England', 'Wicketkeeper-Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Bairstow'),
        ...
        ('Faf du Plessis', 'South Africa', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Faf'),
        ...
        ('Hashim Amla', 'South Africa', 'Batsman',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Amla'),
        ...
        ('Angelo Mathews', 'Sri Lanka', 'All-rounder',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Mathews'),
        ...
        ('Lasith Malinga', 'Sri Lanka', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Malinga'),
        ...
        ('Brendon McCullum', 'New Zealand', 'Batsman',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=McCullum'),
        ...
        ('Martin Guptill', 'New Zealand', 'Batsman',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Guptill'),
        ...
        ('Virender Sehwag', 'India', 'Batsman',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Sehwag'),
        ...
        ('Yuvraj Singh', 'India', 'All-rounder',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Yuvraj'),
        ...
        ('Zaheer Khan', 'India', 'Bowler',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Zaheer'),
        ...
        ('Harbhajan Singh', 'India', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Harbhajan'),
        ...
        ('Shikhar Dhawan', 'India', 'Batsman',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Dhawan'),
        ...
        ('Dinesh Karthik', 'India', 'Wicketkeeper-Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=DK'),
        ...
        ('Bhuvneshwar Kumar', 'India', 'Bowler',
         ...
         'Injury concerns.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Bhuvi'),
        ...
        ('Yuzvendra Chahal', 'India', 'Bowler',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Chahal'),
        ...
        ('Kuldeep Yadav', 'India', 'Bowler',
         ...
         'Form fluctuations.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Kuldeep'),
        ...
        ('Mohammad Amir', 'Pakistan', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Amir'),
        ...
        ('Younis Khan', 'Pakistan', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Younis'),
        ...
        ('Inzamam-ul-Haq', 'Pakistan', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Inzamam'),
        ...
        ('Javed Miandad', 'Pakistan', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Miandad'),
        ...
        ('Shahid Afridi', 'Pakistan', 'All-rounder',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Afridi'),
        ...
        ('Saeed Anwar', 'Pakistan', 'Batsman',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Anwar'),
        ...
        ('Alastair Cook', 'England', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Cook'),
        ...
        ('Kevin Pietersen', 'England', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=KP'),
        ...
        ('Andrew Flintoff', 'England', 'All-rounder',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Freddie'),
        ...
        ('Ian Botham', 'England', 'All-rounder',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Botham'),
        ...
        ('Stuart Broad', 'England', 'Bowler',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Broad'),
        ...
        ('Shaun Pollock', 'South Africa', 'All-rounder',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Pollock'),
        ...
        ('Allan Donald', 'South Africa', 'Bowler',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Donald'),
        ...
        ('Mahela Jayawardene', 'Sri Lanka', 'Batsman',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Mahela'),
        ...
        ('Sanath Jayasuriya', 'Sri Lanka', 'All-rounder',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Sanath'),
        ...
        ('Arjuna Ranatunga', 'Sri Lanka', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Arjuna'),
        ...
        ('Chaminda Vaas', 'Sri Lanka', 'Bowler',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Vaas'),
        ...
        ('Curtly Ambrose', 'West Indies', 'Bowler',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Ambrose'),
        ...
        ('Courtney Walsh', 'West Indies', 'Bowler',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Walsh'),
        ...
        ('Garfield Sobers', 'West Indies', 'All-rounder',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Sobers'),
        ...
        ('Clive Lloyd', 'West Indies', 'All-rounder',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Lloyd'),
        ...
        ('Chris Gayle', 'West Indies', 'Batsman',
         ...
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Gayle'),
        ...
        ('Andy Flower', 'Zimbabwe', 'Wicketkeeper-Batsman',
         ...
         'Minimal controversies.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Flower'),
        ...
        ('Heath Streak', 'Zimbabwe', 'All-rounder',
         ...
         'Corruption ban 2021.',
         'https://via.placeholder.com/400x300/667eea/ffffff?text=Streak'),
    ]
